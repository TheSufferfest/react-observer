let event_black_list = ['mousemove', 'mouseout', 'mousein', 'mouseover', 'pointermove', 'pointerout', 'pointerover', 'focus', 'blur', 'devicemotion', 'deviceorientation', 'hashchange', 'selectstart', 'selectionchange', 'popstate'];
